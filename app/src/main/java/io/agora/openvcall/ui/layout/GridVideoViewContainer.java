...
public class GridVideoViewContainer extends RecyclerView {
    ...
    private boolean initAdapter(AppCompatActivity activity, int localUid, HashMap<Integer, SurfaceView> uids) {
    ...
    public void initViewContainer(AppCompatActivity activity, int localUid, HashMap<Integer, SurfaceView> uids, boolean isLandscape) {
